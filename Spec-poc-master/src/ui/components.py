...
def render_triangulation_section() -> tuple[bool, str]:
    ...
    st.markdown("*Process CSV datasets and PNS JSON to extract and triangulate buyer specifications*")
...
def render_final_results(triangulated_result: str, triangulated_table: List[Dict[str, Any]]):
    ...
    # New 3-stage results display
    render_three_stage_results(final_results)
