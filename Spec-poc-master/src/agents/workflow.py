...
class SpecExtractionWorkflow:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        # Set entry point - 4 agents start simultaneously (PNS commented out)
        ...
        # All agents flow to the completion checker (PNS commented out)
    ...
    def _wait_for_completion(self, state: SpecExtractionState) -> SpecExtractionState:
        ...
        # Get status for uploaded sources
